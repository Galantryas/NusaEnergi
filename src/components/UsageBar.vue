  ...
  async mounted() {
    ...
    if(this.mda==0){
      chart.data = [
        {
          day: yesterday,
          energy: res.data.yesterday.sumOfIntensity
        },
        {
          day: today,
          energy: res.data.today.sumOfIntensity
        }
      ];
    }else if(this.mda==1){
      chart.data = [
      {
        day: lastMonth,
        energy: res.data.lastMonth.sumOfIntensity
      },
      {
        day: thisMonth,
        energy: res.data.thisMonth.sumOfIntensity
      }
    ];
    }else if(this.mda==2){
      chart.data = [
      {
        day: lastYear,
        energy: res.data.lastYear.sumOfIntensity
      },
      {
        day: thisYear,
        energy: res.data.thisYear.sumOfIntensity
      }
    ];
    }
